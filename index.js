...
function countVowelsAndConsonants(word) {
  ...
  for (const elem of word) {
    const lowCase = elem.toLowerCase();
    if (letters.includes(lowCase)) {
      letterCount1++;
      console.log(`Голосні: ${letterCount1}`);
    } else {
      letterCount2++;
      console.log(`Приголосні: ${letterCount2}`);
    }
  }
}
